...
module Test.Example.OpensslVariables
  ...
  test_objs_6, test_objs_7, test_objs_8, test_objs_9, test_objs_10, test_objs_11
  ) where
...
test_objs_7 = ["test/drbgtest-bin-drbgtest.o"
              ,"test/evp_extra_test-bin-evp_extra_test.o"
...
test_objs_8 = ["test/testutil/libtestutil-lib-apps_mem.o", "test/testutil/libtestutil-lib-basic_output.o", "test/testutil/libtestutil-lib-cb.o", "test/testutil/libtestutil-lib-driver.o", "test/testutil/libtestutil-lib-format_output.o", "test/testutil/libtestutil-lib-init.o", "test/testutil/libtestutil-lib-main.o", "test/testutil/libtestutil-lib-options.o", "test/testutil/libtestutil-lib-output_helpers.o", "test/testutil/libtestutil-lib-random.o", "test/testutil/libtestutil-lib-stanza.o", "test/testutil/libtestutil-lib-tap_bio.o", "test/testutil/libtestutil-lib-test_cleanup.o", "test/testutil/libtestutil-lib-test_options.o", "test/testutil/libtestutil-lib-tests.o"]

test_objs_9 = ["test/rsa_sp800_56b_test-bin-rsa_sp800_56b_test.o"]

test_objs_10 = ["test/provider_internal_test-bin-p_test.o", "test/provider_test-bin-provider_test.o"
...
test_tls13secretstest_objs = ["crypto/tls13secretstest-bin-packet.o", "ssl/tls13secretstest-bin-tls13_enc.o", "test/tls13secretstest-bin-tls13secretstest.o", "test/libtestutil.a"]
test_uitest_objs = ["apps/lib/uitest-bin-apps_ui.o", "test/uitest-bin-uitest.o", "test/libtestutil.a"]
