...
apps_openssl_objs = ["apps/openssl-bin-asn1pars.o", "apps/openssl-bin-ca.o"
                    ...
                    ,"apps/openssl-bin-ocsp.o", "apps/openssl-bin-openssl.o"
                    ,"apps/openssl-bin-passwd.o", "apps/openssl-bin-pkcs12.o"
                    ,"apps/openssl-bin-pkcs7.o", "apps/openssl-bin-pkcs8.o"
                    ,"apps/openssl-bin-pkey.o", "apps/openssl-bin-pkeyparam.o"
                    ,"apps/openssl-bin-pkeyutl.o", "apps/openssl-bin-prime.o"
                    ,"apps/openssl-bin-progs.o", "apps/openssl-bin-provider.o"
...
test_aesgcmtest_objs = ["test/aesgcmtest-bin-aesgcmtest.o", "test/libtestutil.a"] 
...
test_asn1_dsa_internal_test_objs = ["test/asn1_dsa_internal_test-bin-asn1_dsa_internal_test.o", "test/libtestutil.a", "libcrypto.a"]
...
test_gosttest_objs = ["test/gosttest-bin-gosttest.o", "test/gosttest-bin-ssltestlib.o", "test/libtestutil.a"]
